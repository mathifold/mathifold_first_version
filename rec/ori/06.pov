...
parametric {
  function { (2+v*sin(0.5*u))*cos(u) },  //function { (2+v*sin(0.54374*u-7.87337/180*pi))*cos(u) },          // x-axis
  function { v*cos(0.5*u) },  //function { v*cos(0.54374*u-7.87337/180*pi) },                        // y-axis
  function { (2+v*sin(0.5*u))*sin(u) } // function { (2+v*sin(0.54374*u-7.87337/180*pi))*sin(u) }            // z-axis
  ...
  texture{pigment{color rgb <2, 3,2>}  //<2, 3,2>
